...
export const EmulatorSpeed = MakeLocalStore<number>('option-emulator-speed', 1);
export const HoldSpaceForSpeed = MakeLocalStore<boolean>('option-hold-space-for-speed', false);
